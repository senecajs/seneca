    ...
    s0.act('a:1,x:2', function (err, out) {
      ...
      s0.act('a:1,x:s', function (err, out) {
        ...
        expect(err.message).equal(
          'seneca: Action a:1 received an invalid message; Validation failed for property "x" with value "s" because the value is not of type number.; message content was: { a: 1, x: \'s\' }.',
        )
        fin()
      })
    })
