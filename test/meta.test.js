    ...
    Seneca()
      ...
      .act(
        ...
        function (ignore, out, meta) {
          ...
          this.act(
            { b: 1, t: 1, meta$: { custom: { foo: 1 } } },
            function (ignore, out, meta) {
              expect(meta.custom.foo).equal(1)

              this.act(
                { c: 1, t: 2, meta$: { custom: { foo: 2 } } },
                function (ignore, out, meta) {
                  expect(meta.custom.foo).equal(2)

                  this.act(
                    { d: 1, t: 11, meta$: { custom: { foo: 0 } } },
                    function (ignore, out, meta) {
