...
function act(...args) {
    ...
    var spec = (0, common_1.build_message)(instance, args, 'reply:f?', instance.fixedargs);
    var msg = spec.msg;
...
function post(...args) {
    ...
    return new Promise((res, rej) => {
        seneca.act(...args, function (err, out) {
...
function do_act(instance, opts, origmsg, origreply) {
    ...
    var meta = new meta_1.Meta(instance, opts, origmsg, origreply);
    if (meta.gate) {
    ...
    execspec.fn = function act_fn(done) {
        try {
            intern.execute_action(execspec, instance, opts, actctxt, actmsg, meta, function action_reply(err, out, reply_meta) {
                if (!timedout) {
            ...
            var ex = (0, common_1.isError)(e) ? e : new Error((0, common_1.inspect)(e));
    ...
    execspec.ontm = function act_tm(timeout, start, end) {
        timedout = true;
        var timeout_err = (0, common_1.error)('action_timeout', {
            timeout: timeout,
            start: start,
            end: end,
            message: actmsg,
...
function handle_reply(opts, meta, actctxt, actmsg, err, out, reply_meta) {
    meta.end = Date.now();
...
function process_outward(actctxt, data) {
...
function execute_action(execspec, act_instance, opts, actctxt, msg, meta, reply) {
...
function make_act_delegate(instance, _opts, meta, actdef) {
    meta = meta || {};
    actdef = actdef || {};
    var delegate_args = {
        plugin$: {
...
function callback_error(instance, thrown_obj, ctxt, data) {
    ...
    var meta = data.meta;
    var msg = data.msg;
    var err = (0, common_1.isError)(thrown_obj)
        ? thrown_obj
