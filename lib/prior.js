...
const inward_1 = require("./inward");
const act_1 = require("./act");
const meta_1 = require("./meta");
const prior_inward = new ordu_1.Ordu({
    name: 'prior_inward',
})
...
function api_prior() {
    ...
    var spec = (0, common_1.build_message)(this, arguments, 'reply:f?', this.fixedargs);
    ...
    if (priordef) {
        if (opts.prior.direct) {
            ...
            const prior_meta = new meta_1.Meta(this, opts, msg, prior_reply);
            const prior_instance = act_1.Act.intern.make_act_delegate(this, opts, prior_meta, priordef);
            // Reply annotations.
