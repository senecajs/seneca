...
function MemStore() {
  ...
  self.remove = function(qent,q,cb) {
    ...
    var name = qent.$.$name;
    var tenant = qent.$.$tenant;
    //var ent = self.entmap[base] ? self.entmap[base][name] ? self.entmap[base][name] ? self.entmap[base][name][tenant] ? self.entmap[base][name][tenant][q.id] ? self.entmap[base][name][tenant][q.id] : null : null : null : null;
    //if( ent ) {
