...
function Entity( $, si ) {
  ...
  self.make$ = function() {
    ...
    var new$ = {}
    new$.name$     = props.name$   || $.name$;
    new$.base$     = props.base$   || $.base$;
    new$.tenant$   = props.tenant$ || $.tenant$;
  ...
  self.canon$ = function(opt) {
    if( opt ) {
      return ( opt.string ? [$.tenant$,$.base$,$.name$].join('/')
               : opt.array  ? [$.tenant$,$.base$,$.name$]
               : opt.object ? {tenant:$.tenant$,base:$.base$,name:$.name$}
               : [$.tenant$,$.base$,$.name$] )
    }  
    else return [$.tenant$,$.base$,$.name$]
  }
  ...
  self.data$ = function(data) {
    if( data ) {
      ...
      data.$ = {tenant$:$.tenant$,base$:$.base$,name$:$.name$}
      return data
    }
  }
