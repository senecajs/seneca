...
exports.parsePattern = function parse_pattern(
  ...
  args.pattern = Object.assign(
    ...
    args.strargs ? parse_jsonic(args.strargs, 'add_string_pattern_syntax') : null,
    fixed
  )

  args.pattern.__proto__ = (args.moreobjargs || args.objargs || {}).__proto__
...
exports.make_standard_act_log_entry = function(actdef, msg, origmsg, ctxt) {
...
*/
    ...
    var origproto = obj.__proto__
    var metaobj = { meta$: meta }

    metaobj.__proto__ = origproto
    obj.__proto__ = metaobj
  }
...
function History(opts) {
  ...
  if(opts.prune) {
    this._prunehist = []
    this._prune_interval = setInterval(this.prune.bind(this), opts.interval || 100)
  }
}
