...
function build_message(_instance, rawargs, normaspec, fixed) {
    let args = Norma('{strargs:s? objargs:o? moreobjargs:o? ' + (normaspec || '') + '}', rawargs);
    // Precedence of arguments in add,act is left-to-right
