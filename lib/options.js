...
module.exports = function(callmodule, defaults, orig_initial) {
  ...
  function prepare(basemodule, defaults, initial) {
    ...
    // options debug.argv allows for testing
    var argv = Minimist(
    ...
    //console.log('LOAD OPTS LOG', out.log)
  ...
  function parse_command_line_log(spec, parsedSpec) {
    ...
    //console.log('PCLL logSpec', logSpec)
    ...
    if (_.isString(logSpec)) {
      ...
      //console.log('PCLL str', parsedSpec)
    ...
    //console.log('PCLL obj', parsedSpec)
  }
