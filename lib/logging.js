...
exports.log_act_in = function (instance, actinfo, actmeta, args, prior_ctxt, act_callpoint) {
  ...
  instance.log.debug(
    ...
    function () {
      return [
        actmeta.func && actmeta.func.descdata ? actmeta.func.descdata(args) : Jsonic.stringify(args),
        (prior_ctxt.entry
          ? 'ENTRY'
...
exports.log_act_out = function (instance, actinfo, actmeta, args, result, prior_ctxt, act_callpoint) {
  ...
  instance.log.debug(
    ...
    function () {
      return _.flatten([
        (actmeta.func && actmeta.func.descdata
         ? actmeta.func.descdata(result[1])
