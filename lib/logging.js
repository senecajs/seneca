...
exports.log_act_in = function( instance, actinfo, actmeta, args ) {
...
exports.log_act_out = function( instance, actinfo, actmeta, args, result ) {
  if( actmeta.sub ) return;
...
exports.log_act_err = function( instance, actinfo, actmeta, args, err ) {
  instance.log.error(
    'act',
...
exports.log_act_cache = function( instance, actinfo, actmeta, args ) {
  instance.log.debug(
    'act',
    actmeta.plugin_name,
    actmeta.plugin_tag,
