...
function make_seneca($, opts) {
  ...
  //set up an options getter, this way if options are
  //changed by another plugin things will just work
  Object.defineProperty(self.store, 'options', {
    get: function () {
  ...
  //hack in seneca.options in prep for new version
