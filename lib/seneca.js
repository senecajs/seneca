...
function make_seneca(initial_options ) {
  ...
  private$.clientrouter = patrun(function(pat,data) {
    var gexers = {}
  ...
  function api_client() {
    ...
    var sendclient = {
      send: function( args, done ) {
        sendqueue.push( {instance:this, args:args, done:done } )
      }
    }
  ...
  function do_act(instance,actmeta,isprior,origargs,cb) {
    ...
    if( null != args.actid$ && so.actcache ) {
      ...
      if( actdetails ) {
        ...
        logging.log_act_cache( instance, args.actid$, actmeta, args )
    ...
    function perform(actmeta) {
      ...
      logging.log_act_in( root, actid, actmeta, args )
      ...
      var act_done = function(err) {
        ...
        if( err ) {
          ...
          logging.log_act_err( root, actid, actmeta, args, err )
          ...
          logging.log_act_out( instance, actid, actmeta, args, result )
