  ...
  self.add = function() {
    ...
    if( _.isString( args) ) {
      ...
      try {
        ...
        throw self.fail('add_string_args_syntax',{argstr:args,syntax:e.message,line:e.line,col:col})
      }
...
var MSGMAP = {
  seneca:{
    ...
    add_string_args_syntax: 'Could not add action due to syntax error in pattern string: "<%=argstr%>": Line:<%=line%>, Column:<%=col%>; <%=syntax%>',
