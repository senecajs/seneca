...
//get web working again, use http metadata better
...
function make_seneca($, initial_options ) {
  ...
  function do_act(instance,actmeta,isprior,origargs,cb) {
    ...
    var actid = ((instance.fixedargs&&instance.fixedargs.actid)?instance.fixedargs.actid+'/':'')+self.idgen()
