...
function make_seneca(initial_options ) {
  ...
  private$.clientrouter = patrun(function(pat,data) {
    ...
    //console.log('CR-gc',gexers)

    return function(args,data) {
      //console.log('CR-g',gexers)
      //console.log('CR-f',args,data)
  ...
  function api_client() {
    ...
    _.each(pins,function(pin) {
      ...
      //console.log('cr',private$.clientrouter)
    })
  ...
  function api_start( errhandler ) {
    ...
    dzig.start(function(){
      var self = this
      dzig.end(function(){errhandler && errhandler.apply(self,arguments)})
    })
