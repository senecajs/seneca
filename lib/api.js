...
function decorate() {
    ...
    Assert(this.private$.decorations[property] === undefined, 'seneca is already decorated with the property: ' + property);
    Assert(this.root[property] === undefined, 'cannot override a core seneca property: ' + property);
