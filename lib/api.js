...
exports.find = function (pattern, flags) {
  ...
  var actmeta = seneca.private$.actrouter.find(pat, flags && flags.exact)
  ...
  if (!reply) {
    if (res.strict) {
      ...
      reply = function reply() {
        instance.log.warn(Common.make_standard_err_log_entry(
          internals.error('unknown_message_reply', {id: id, args: arguments})
        ))
      }
    }
  } 
