...
function MemStore() {
  ...
  self.init = function(seneca,opts,cb) {
    ...
    seneca.add({on:self.name,cmd:'save'},function(args,seneca,cb){
      var ent = args.ent
    ...
    seneca.add({on:self.name,cmd:'load'},function(args,seneca,cb){
      var qent = args.qent
      var q    = args.q
    ...
    seneca.add({on:self.name,cmd:'list'},function(args,seneca,cb){
      var qent = args.qent
      var q    = args.q
    ...
    seneca.add({on:self.name,cmd:'remove'},function(args,seneca,cb){
      var qent = args.qent
      var q    = args.q
    ...
    seneca.add({on:self.name,cmd:'close'},function(args,seneca,cb){
      cb && cb()
    })
