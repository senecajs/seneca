...
class InstanceImpl {
    ...
    constructor(initial_opts) {
        // Mark the Seneca object
        this.isSeneca = true;
        this.version = '';
        this.id = '';
        this.did = '';
        this.fixedargs = undefined;
        this.fixedmeta = undefined;
        this.start_time = -1;
...
const makeSeneca = (seneca_options, more_options) => {
    ...
    var seneca = new InstanceImpl(initial_opts);
