...
# Plugins
Seneca is nothing without plugins, plugins are how we enable you to build awesome microservices, incredibly
...
Our docs are open source, simply fork [seneca-docs]() repository, add your plugin to the appropriate section,
